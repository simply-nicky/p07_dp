...
class Scan(object):
    ...
    def full_stxm(self):
        ...
        _full_stxm[0] = _full_stxm[0] / _full_stxm[1]; _full_stxm[2] = _full_stxm[2] / _full_stxm[1]
        _full_stxm = [utils.pad_stxm(_stxm, self.coords.fast_size, self.coords.slow_size) for _stxm in _full_stxm]
